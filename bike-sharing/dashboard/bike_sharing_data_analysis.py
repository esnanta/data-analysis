...
# Create a local data folder to store the dataset
data_folder = os.path.join(os.getcwd(), 'data')  # 'data' folder in the current working directory
...
if response.status_code == 200:
    ...
    exit()  # Stop further execution if download fails
...
if os.path.exists(day_csv_path) and os.path.exists(hour_csv_path):
    print(f"Dataset extracted successfully to {data_folder}!")
else:
